                            ...
                            <v-list-item-content>
                                <v-list-item-title>
                                    <v-text-field v-model="newTodo" id="newTodo" name="newTodo"
                                        label="Kezd el beírni a feladat nevét" @keyup.enter="addTodo" :hint="todoExists"
                                        persistent-hint color="#00000099" />
                                </v-list-item-title>
                            </v-list-item-content>
                        </v-list-item>
                    </v-list>
                            ...
                            <v-list-item v-for="(todo, i) in filteredItems" :key="i">
                                <template #default="{ active }">
                                    ...
                                    <v-list-item-content>
                                        ...
                                        <v-list-item-subtitle>Hozzáadva: {{ todo.createdAt }}</v-list-item-subtitle>
                                    </v-list-item-content>
                                    <v-btn fab ripple small color="#359756" v-if="active" @click="removeTodo(i)">
