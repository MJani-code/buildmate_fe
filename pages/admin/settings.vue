                            ...
                            <v-form ref="form" @submit.prevent="onSubmit">
                                ...
                                <v-row>
                                    ...
                                    <v-col cols="12" lg="6" xl="6" v-if="editMode">
                                        <v-text-field :clearable="editMode" type="password" color="#359756"
                                            v-model="user.newPassword" :readonly="!editMode" :filled="!editMode"
                                            label="Új jelszó" :rules=newPasswordRule></v-text-field>
                                    </v-col>
                                    <v-col cols="12" lg="6" xl="6" v-if="editMode">
                                        <v-text-field :clearable="editMode" type="password" color="#359756"
...
export default {
    ...
    computed: {
        newPasswordRule() {
            return [
                v => !v || /[A-Z]/.test(v) || 'A jelszónak legalább egy nagybetűt kell tartalmaznia',
                v => !v || /[0-9]/.test(v) || 'A jelszónak legalább egy számot kell tartalmaznia',
                v => !v || (v.length >= 8) || 'A jelszónak legalább 8 karakter hosszúnak kell lennie'
            ]
        },
