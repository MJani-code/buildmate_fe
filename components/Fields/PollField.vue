            ...
            <v-expansion-panels>
                <v-expansion-panel v-for="(poll, index) in polls" :key="index">
                    ...
                    <v-expansion-panel-content>
                        <v-form>
                            <div>
                                <v-checkbox color="#359756" v-for="(choice, choiceIndex) in poll.choices" :key="choiceIndex" :id="poll.id" :value="choice"
                                    :label=poll.choices[choiceIndex]></v-checkbox>
                            </div>
                        </v-form>
                    </v-expansion-panel-content>
                </v-expansion-panel>
...
export default {
    ...
    data: () => ({
        polls: [
            { id: '1', question: 'q1', status: '', multiple: false, choices: ['a1', 'a2', 'a3'] },
            { id: '2', question: 'q2', status: '', multiple: false, choices: ['a1', 'a2'] },
            { id: '3', question: 'q3', status: '', multiple: false, choices: ['a1'] }
        ],
    })
}
</script> -->